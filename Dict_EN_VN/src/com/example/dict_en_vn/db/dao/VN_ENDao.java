 ...
 * DAO for table NOTE.
*/
public class VN_ENDao extends AbstractDao<Note, Long> {

    public static final String TABLENAME = "VN - EN";
    ...
    */
    ...
    public VN_ENDao(DaoConfig config) {
        super(config);
    }
    
    public VN_ENDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }
    public List<Note> getListLimit(SQLiteDatabase db, String search){
    	String textColumn = VN_ENDao.Properties.Word.columnName;
		 String orderBy = textColumn + " COLLATE LOCALIZED ASC";
		 String sqlStr = "select * from " + "'"+getTablename()+"'"+" WHERE  "+VN_ENDao.Properties.Word.columnName+" like '"+search+"%' order by "+VN_ENDao.Properties.Word.columnName+" ASC LIMIT 0,5 ";
...
//		 Cursor cursor = db.query(getTablename(), getAllColumns(), null, null, null, null, orderBy);
    ...
    public Note getDataWithID(SQLiteDatabase db, long id) {
    	String Query = "Select * from " + getTablename() + " where " + VN_ENDao.Properties.Id.columnName + "="
    			+ id;
    	Cursor cursor = db.rawQuery(Query, null);
    	Note  note= null;
    	if (cursor.moveToFirst()){
